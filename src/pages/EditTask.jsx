    ...
    <div>
      ...
      <main>
        ...
        <form className="new-task-form">
          <label>タイトル</label><br />
          <input type="text" onChange={handleTitleChange} className="new-task-title" value={title} /><br />
          <label>詳細</label><br />
          <textarea type="text" onChange={handleDetailChange} className="new-task-detail" value={detail} /><br />
          <div>
          ...
          <button type="button" className="new-task-button" onClick={onUpdateTask}>更新</button>
        </form>
      </main>
    </div>
  )
